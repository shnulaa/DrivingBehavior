 ...
 */
public class ViolRushLaunchData extends ViolSerializable {

	/**
	 * 急起步违反类型ID
	 */
	private static byte VIOL_RUSHLUNCH_TYPE = 8;
	...
	/**
	 * ViolRushLaunchData:急起步违反构造函数
	 */
	public ViolRushLaunchData() {

		// 设置急起步违反类型ID
		super((byte) VIOL_RUSHLUNCH_TYPE);
	}
